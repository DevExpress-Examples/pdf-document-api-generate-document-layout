...
Namespace DrawAPI
    ...
    Friend Class Program
        ...
        Private Shared Sub Draw(ByVal page As PdfPage)
            Using graphics As PdfGraphics = New PdfGraphics()
                ...
                Using font1 As Font = New Font("Segoe UI", 32, FontStyle.Bold)
                    graphics.DrawString("Andrew Fuller", font1, black, 300, 90)
                End Using

                Using font2 As Font = New Font("Segoe UI", 20)
                    graphics.DrawString("Vice President, Sales", font2, black, 300, 145)
                End Using

                Using font3 As Font = New Font("Segoe UI", 14)
